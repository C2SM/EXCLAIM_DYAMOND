...
! max_lay_thckn  = 400.      ! May layer thickness below th height given by htop_thcknlimit (CLM & NWP recomendation 400)
 ...
 flat_heigh      = 25000.   ! Height above whihc coordinatre surfaces are flat  (default value)
/
...
&lnd_nml
  sstice_mode    = 6  ! 4: SST and sea ice fraction are updated daily, based on actual monthly means
...
&output_nml
 output_filename = "${EXPNAME}_atm_3d_out1"          ! file name base
 filename_format = "${EXPNAME}_out32_<datetime2>"     ! Output file format
 filetype        = 5 ! NetCDF4
 ...
 file_interval   = "PT6H"
 include_last    = .true.
 pl_varlist      = 'qc', 'qr', 'qi', 'qs', 'qg', 'temp', 'u', 'v', 'w'
...
&output_nml
 output_filename = "${EXPNAME}_atm_2d_out10"          ! file name base
...
&output_nml
 filename_format = "${EXPNAME}_out12_<datetime2>"     ! Output file format
 filetype        = 5 ! NetCDF4
 output_start    = "${start_date}"
 output_end      = "${end_date}"
 output_interval = "PT1H"
...
&output_nml
 filename_format = "${EXPNAME}_out13_<datetime2>"     ! Output file format
 filetype        = 5 ! NetCDF4
 output_start    = "${start_date}"
 output_end      = "${end_date}"
 output_interval = "PT1H"
